...
function P6ParallelCases() {
  ...
  const cases = [
    ...
    { id:1, industry:'RegTech · Global', color:'#5a9e82', title:'ESMA — Social Media Bubble Monitoring', tag:'Behavioral signal validation', desc:'European Securities and Markets Authority now uses social media sentiment + search trends as early warning indicators for market surveillance.', ref:'European Securities Markets Authority · esma.europa.eu', refUrl:'https://www.esma.europa.eu', analysis:'ESMA\'s Market Intelligence function explicitly monitors retail investor sentiment via social media and search trends — the same behavioral signal this study uses via Google Trends SVI. Their GameStop report (2021) confirmed that retail search momentum preceded price spikes by 5-10 days. This study applies the same logic to Vietnamese market bubbles, where retail investor participation is even higher as a % of total market activity.', approach:'Social media sentiment monitoring + search trend surveillance + retail order flow analysis', relevance:'Regulatory validation that behavioral signals (Google Trends) are legitimate early warning tools' },
    { id:2, industry:'Finance · Vietnam', color:'#e8729a', title:'SSC Vietnam — Market Surveillance 2023', tag:'Direct local application', desc:'State Securities Commission of Vietnam identified retail investor over-concentration as the key systemic risk in the 2022 crash — exactly what Google Trends measured.', ref:'State Securities Commission · ssc.gov.vn', refUrl:'https://www.ssc.gov.vn', analysis:'The SSC\'s post-mortem on the 2022 crash specifically cited "FOMO-driven retail participation" as the primary bubble mechanism — the exact phenomenon Google Trends Delta-SVI captures. This study provides the SSC with a quantifiable, real-time proxy for that FOMO. The proposed 3-tier alert system maps directly to SSC\'s existing market surveillance framework (normal → watch → intervention levels), requiring no institutional redesign to implement.', approach:'Real-time market surveillance with intervention thresholds tied to objective data signals', relevance:'System designed to be implementable within SSC\'s existing surveillance framework' },
  ];
  const activeCase = active!==null ? cases[active] : null;
  return (
    <div style={{display:'flex',flexDirection:'column',gap:10}}>
