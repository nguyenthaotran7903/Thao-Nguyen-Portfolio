                              ...
                              <div className={styles.panelContent}>
                                ...
                                <div className={styles.panelBlock}>
                                  ...
                                  <div className={styles.reflectGrid}>
                                    ...
                                    <div className={styles.reflectCard} style={{borderTopColor:'#9060c0'}}><div className={styles.reflectHeader} style={{color:'#9060c0'}}><span>→</span> What I would do differently</div><ul className={styles.reflectList}><li>Add <span className={styles.reflectHL}>bank-specific loan type breakdown</span> — real estate heavy banks behave differently from consumer credit banks</li><li>Turn the regression coefficients into a <span className={styles.reflectHL}>simple scoring tool</span> — given a bank's size, last year's NPL, and current macro data, it could output a risk trajectory estimate without needing a full model rerun
                                  </div>
                                </div>
